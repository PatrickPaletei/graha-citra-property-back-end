...
interface PropertyTypeService {
    fun addPropertyType(propertyType: String): ResponseEntity<BaseResponse<Any>>
    ...
    fun updatePropertyType(mstPropertyType: MstPropertyType,propertyTypeId: Int, propertyTypeName: String): ResponseEntity<BaseResponse<Any>>
}